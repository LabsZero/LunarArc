...
/**
 * Paper-compatible view of Minecraft's live world border.
 *
 * <p>This class deliberately owns no loader-specific state. The backing border is the
 * vanilla/NMS object supplied by the active platform adapter, so NeoForge, Fabric,
 * Forge and Quilt all observe the same Bukkit state as the underlying world.</p>
 */
