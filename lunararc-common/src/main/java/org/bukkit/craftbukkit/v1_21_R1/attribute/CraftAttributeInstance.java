...
/**
 * Paper-1.21.1 compatible bridge around Minecraft's key-based attribute
 * modifiers. 1.21 changed NMS modifiers from UUID identity to ResourceLocation
 * identity, while Bukkit temporarily keeps both UUID and key accessors.
 */
