 ...
 *
 * <p>Edit {@code gradle/incompatibility.toml}, beside {@code libs.versions.toml}, and rebuild. That file
 * documents the schema and is the only place entries are written. The build parses it and emits
 * {@code lunararc/incompatibility.tsv} into the jar; this class reads that resource and nothing else.</p>
 *
...
public final class IncompatibilityList {
    ...
    static {
        ...
        // Generated by the generateIncompatibilityList Gradle task from gradle/incompatibility.toml. Absent only
