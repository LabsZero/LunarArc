...
public final class PluginBootstrapContextImpl implements BootstrapContext {
    ...
    @Override
    public io.papermc.paper.plugin.lifecycle.event.@NotNull LifecycleEventManager<BootstrapContext> getLifecycleManager() {
        return new io.papermc.paper.plugin.lifecycle.event.PaperLifecycleEventManager<>(this, () -> true);
    }
}