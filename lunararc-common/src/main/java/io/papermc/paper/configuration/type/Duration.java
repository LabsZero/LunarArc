...
/**
 * Real Paper's Duration also has a Configurate ScalarSerializer inner class for loading from
 * config files — dropped here since LunarArc isn't wiring real per-world config file loading
 * (see WorldConfiguration in this same package for why). Everything else is a verbatim port.
 */
