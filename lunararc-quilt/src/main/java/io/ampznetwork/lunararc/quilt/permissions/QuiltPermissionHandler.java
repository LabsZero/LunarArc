...
/**
 * Delegates Quilt permission checks to Bukkit's permission system.
 * Called from QuiltBridge.hasPermission() to check mod-side permission nodes.
 */
public class QuiltPermissionHandler {
